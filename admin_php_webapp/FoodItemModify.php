   ...
   <body>
      <?php
            $item_id=$_POST['item_id'];
                $query_find = "SELECT * FROM food_item WHERE slno='$item_id'";
      ...
      <div class="container body-height">
         ...
         <div class="jumbotron" style="background-image: url('img/fade.jpg');">
            <div class="page-header">
               <div class="row">
                  <div class="col-sm-9">
                     <h1 style="color: #FFFFFF">Modify Food / Offer </h1>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-xs-12">
               <!--Registration Form-->
               <form action="FoodOfferList.php" enctype="multipart/form-data" method="POST">
                  <div class="form-group">
                     <label for="food_title">Food/Offer Title</label>
                     <input required id="food_title" name="food_title" type="text" class="form-control" value="<?php echo $row['food_title']?>">
                  </div>
                  
                  <div class="form-group">
                     <label for="description">Description</label>
                     <textarea rows="3" id="description" name="description" class="form-control" ><?php echo $row['description']?>    
                     </textarea>
                  </div>
                  <div class="form-group">
                     <label for="price">Price</label>
                     <input required id="price" type="text" name="price" class="form-control" value="<?php echo $row['price']?>">
                  </div>
                  <div class="form-group">
                     <label for="food_avl">Avialabilty</label>
                     <select name="food_avl" id="food_type" class="form-control">
                        <option value="1">Yes</option>
                        <option value="0" <?php if($row['food_type']=='Non-Veg') echo 'selected' ?> >No</option>
                     </select>
                  </div>
                  <div class="form-group">
                     ...
                     <select name="food_type" id="food_type" class="form-control" onchange="itemChange(this);">
                        ...
                        <option value="Non-Veg" <?php if($row['food_type']=='Non-Veg') echo 'selected' ?> >Non-Veg</option>
                     </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                        <img src="./uploads/<?php echo $row['food_image']?>" id="logo" width="200px" class="img-fluid img-thumbnail">
                     </div>
                  </div>
                  <input type="hidden" value="<?php echo $item_id; ?>" name="item_id">
                  <input type="submit" name="btnUpdateFoodOffer" value="Update" class="btn btn-primary">
               </form>
            </div>
         </div>
      </div>
